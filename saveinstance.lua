...
do
	...
	finder, global_container = loadstring(
		game:HttpGet("https://raw.githubusercontent.com/Utoh-lua/SomeHub/main/" .. filename .. ".luau", true),
		filename
	)()
...
do
	...
	local NotScriptableFixes =
		{ -- For more info: https://github.com/Utoh-lua/UniversalSynSaveInstance/blob/master/Tests/Potentially%20Missing%20Properties%20Tracker.luau
			Instance = {
...
--- @field IsolatePlayers boolean -- * This option does save players, it's just they won't show up in Studio and can only be viewed through the place file code (in text editor). More info at https://github.com/Utoh-lua/UniversalSynSaveInstance/issues/2. ___Default:___ false
